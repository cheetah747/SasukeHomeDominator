...
class MainPre(val activity: MainActivity,val cardViews: List<View>) {
    val cardDataList by lazy {
        listOf(
            CardData(null,R.string.screen_lock,R.drawable.lock_screen_30dp, null,R.mipmap.lock_screen_shotcut_big),
            ...
            CardData(null,R.string.power_menu,R.drawable.power_longpress_30dp, null,R.mipmap.power_longpress_shotcut_big),
            CardData(null,R.string.any_tile,R.mipmap.ic_any_tile,null,R.mipmap.any_tile_shotcut_big),
            CardData(null,R.string.settings,R.drawable.screen_shot_setting_30dp,R.color.big_btn_text_color),
            CardData(null,R.string.fuck_brightness_tile,R.drawable.ic_fuck_brightness_30, null,R.mipmap.fuck_brightness_shotcut_big),
            CardData(null,R.string.notifi,R.drawable.notifi_icon_30dp, null, R.mipmap.notifi_shotcut_big)
         )
    }
